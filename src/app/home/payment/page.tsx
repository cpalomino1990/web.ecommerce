...
const PaymentPAge = () => {
    ...
    <div className="w-full px-5 sm:px-10 md:px-32 py-20 gap-5">
        <h2 className="text-3xl font-semibold mb-10 text-pink">Payment</h2>
        ...
        <div className="flex flex-col md:flex-row w-full gap-5">
            ...
            <div className="flex w-full md:w-2/3">
                <Accordion selectedKeys="all" selectionMode="multiple" variant="splitted">
                    <AccordionItem className="font-bold flex flex-col w-full" key="1" aria-label="Accordion 1" title="Dirección">
                        <div className="flex w-full justify-between px-5 py-5 sm:px-10 sm:py-5">
            ...
            <div className="flex w-full md:w-1/3">
                <Card className="w-full py-3 px-3">
                    <CardHeader>
                        <p className="text-xl font-semibold text-pink">Summary</p>
                    </CardHeader>
